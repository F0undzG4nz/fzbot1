...
cfonts.say('Whatsapp Bot By Foundganz',{
font: 'console',
gradient: ['red','magenta'],
align: 'center'
})
...
browser: ["SagiriBot", "Foundzganz", "3.0"],
auth: state
})
